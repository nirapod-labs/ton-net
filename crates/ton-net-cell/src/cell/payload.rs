...
//! what a reader should know: keeping one cell of a bag keeps the bag's bytes. A bag is
//! bounded by [`MAX_CELLS`](crate::MAX_CELLS), so that is a few megabytes at the very most.
//!
